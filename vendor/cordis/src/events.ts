...
export class EventsService {
  ...
  /**
   * Resolve the dispatch `this` and matching listener callbacks for one event.
   *
   * @param type — the dispatch mode, reported on `internal/dispatch`.
   * @param args — the raw dispatch arguments; consumed up to the event name.
   * @returns the dispatch `this` and the filtered listener callbacks.
   */
  ...
  /**
   * @deprecated internal dispatch helper; prefer the mode-specific methods
   * (`emit`, `parallel`, `serial`, `bail`, `waterfall`) which skip
   * per-call callback binding.
   */
